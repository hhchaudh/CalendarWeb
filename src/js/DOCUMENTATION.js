...
/**
*@summary
*@param i: the int representation of month currently on, prev. and next buttons subtract and add 1 to progress, respectively
 ...
 *@return calls addTable(f,l), parameters that are sent to addTable() indicating how to generate the month table. i.e. August starts on a Monday, and there are 31 days in that month.s
 */
function setMonth(){
